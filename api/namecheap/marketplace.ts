/**
 * Vercel Serverless Function — Namecheap Marketplace Proxy
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    const { page = 1, pageSize = 50, maxPrice = 10 } = req.query
    ...
    console.error('Namecheap Marketplace API error:', error)

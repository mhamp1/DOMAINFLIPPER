...
function getEnvCredentials() {
  ...
  return {
    ...
    twitter: {
      bearerToken: import.meta.env.VITE_TWITTER_BEARER_TOKEN || import.meta.env.VITE_X_BEARER_TOKEN || import.meta.env.TWITTER_BEARER_TOKEN || import.meta.env.X_BEARER_TOKEN || '',
    },
    uspto: {
